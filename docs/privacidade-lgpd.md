...
DETRAN SP: Autenticidade de Certidão segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [detran_sp_autenticidade@mcp.ai](mailto:detran_sp_autenticidade@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
